...
of bars even if intermediate runs failed; daily folders therefore overlap
by up to ``PRICE_WINDOW_DAYS - 1`` days and downstream consumers must
dedup on ``(symbol, Date)``.
"""
