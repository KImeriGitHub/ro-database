"""Download historical economic indicator data from Alpha Vantage."""
...
# Mapping from catalog symbol to AV function name + extra query params.
...
async def fetch_economic(
    ...
    """Download historical data for all economic indicators in the catalog."""
